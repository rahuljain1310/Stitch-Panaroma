...
def mergeImage(img1,img2,ds1,ds2,kp1,kp2):
  ...
  if len(matches[:,0]) >= 4:
    ...
    CoordiantesCombined = np.concatenate((CoordinatesImg1,CoordinatesImg2),axis=0)
    # print(CoordinatesImg1,CoordinatesImg2,CoordiantesCombined)
    minX,minY = CoordiantesCombined.min(axis=0)
    maxX,maxY = CoordiantesCombined.max(axis=0)
